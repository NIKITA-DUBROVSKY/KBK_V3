...
DWORD get_fattime (void)
{
	...
	ds3231_read(time_buf, 7);
	secounds = (((time_buf[0] & 0xF0) >> 4) * 10) + (time_buf[0] & 0x0F);
	minute = (((time_buf[1] & 0xF0) >> 4) * 10) + (time_buf[1] & 0x0F);
	hour = (((time_buf[2] & 0xF0) >> 4) * 10) + (time_buf[2] & 0x0F);
	
	day = (((time_buf[4] & 0xF0) >> 4) * 10) + (time_buf[4] & 0x0F);
	month = (((time_buf[5] & 0xF0) >> 4) * 10) + (time_buf[5] & 0x0F);
	year = ((((time_buf[6] & 0xF0) >> 4) * 10) + (time_buf[6] & 0x0F))+2000;
