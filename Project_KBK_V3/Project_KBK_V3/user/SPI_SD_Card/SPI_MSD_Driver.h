...
#define _card_enable()      	GPIO_ResetBits(PORT_CS_SD, GPIO_Pin_CS_SD)
#define _card_power_on()
#define _card_insert()       	GPIO_ReadInputDataBit(PORT_Card_detect, GPIO_Pin_Card_detect)
